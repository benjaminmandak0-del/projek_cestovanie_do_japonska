Pre úspešné absolvovanie predmetu Skriptovacie jazyk je potrebné vyhotoviť projekt, ktorých bude reprezentovať webovú stránku naprogramovanú v jazyku PHP. Minimálne kritériá sú stanovené nasledovne:

Webová stránka musí byť v OOP
...
Autor musí pri realizácii použiť nasledovné komponenty: PHP 8.0 a vyššie, MySQL 8.0 a vyššie alebo MariaDB 10.5 a vyššie
Autor musí uvedený projekt osobne odprezentovať a preukázať znalosť zdrojového kódu
Projekt musí byť unikátny v rámci ročníka - nemôže dôjsť k duplicite 2 rovnakých projektov (rovnaká HTML/CSS/JS šablóna)
...
Vzhľadom na zameranie sa na vedomosti študenta z jazyka PHP, nehodnotíme kvalitu HTML/CSS/JS šablóny. Rovnako tak, má autor možnosť stiahnuť si akúkoľvek šablónu z akéhokoľvek zdroja, zdroj v kurze je len odporúčací. 
